...
import 'package:multi_lang_translator/pages/speech1.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage('asset/Anuvadak!.png'), fit: BoxFit.cover),
      ),
      child: Scaffold(
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(
                    top: MediaQuery.of(context).size.height * 0.05, right: 35),
                child: Row(
                        ...
                        onPressed: (() {
                          showDialog(
                              ...
                              builder: (context) => AlertDialog(
                                    ...
                                    content: Text(
                                      'Anuvadak! is a translation software that translates from Hindi to English and vice-versa.\n\nUsers can give input in multiple formats such as \n -  Text\n -  Speech\n -  Image\n -  Document \n\nOur app also provides courses to learn Hindi & English languages.',
                ...
                child: Column(children: [
                  ElevatedButton.icon(
                    onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Text_Converter())),
                  ...
                  ElevatedButton.icon(
                    onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ImageCameraTranslation())),
                  ...
                  TextButton(
                    onPressed: () {},
                    child: Text('Check out FREE language courses',
                        style: TextStyle(
                            fontSize: 13,
                            color: Colors.black,
                            fontWeight: FontWeight.w500)),
