  ...
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage('asset/pdfHome.png'), fit: BoxFit.cover),
        ),
        child: Scaffold(
          ...
          child: Center(
              ...
              child: Container(
                child: Text(
                  ...
                  style: TextStyle(fontSize: 17, color: Colors.black), //18
            ...
            ElevatedButton(
              ...
              onPressed: _buttonsEnabled ? (() {
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: Text(_text, textAlign: TextAlign.center,),
                  actions: [
